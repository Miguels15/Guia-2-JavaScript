...
do{
   if(!(cantNum = parseInt(prompt("Ingrese la cantidad de numeros que quiere digitar")))){
...
do{
opcion = prompt("Ingrese la palabra ascendente si quiere ver los numeros de mayor a menor y si desea ver los numeros de menor a mayor digite descendente");
opcion.toLowerCase();
